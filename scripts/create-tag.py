...
# 1. update version number in gwspy/__init__.py
...
lines = []
with open(f"{this_file_path}/../src/gwspy/__init__.py", "r") as f:
    for line in f:
...
with open(f"{this_file_path}/../src/gwspy/__init__.py", "w") as of:
    of.writelines(lines)

subprocess.call(["git", "add", f"{this_file_path}/../src/gwspy/__init__.py"])
